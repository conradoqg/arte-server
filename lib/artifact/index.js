...
class Artifact {
    ...
    async getArtifacts(bucket, artifactName, version, metadata) {
        ...
        const artifacts = await this.metadataDB.findArtifacts(bucket.name, artifactName, version, metadata, true);
    ...
    async deleteArtifacts(bucket, artifactName, version, metadata) {
        ...
        const deleteStoragePromises = this.storageDB.removeArtifacts(bucket, artifacts);
