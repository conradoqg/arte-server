...
const artifact = new mongoose.Schema({ bucket: 'string', name: 'string', version: 'string', normalizedVersion: 'string', path: 'string', fileSize: 'number', metadata: 'mixed' }, { timestamps: true });
