...
const artifact = new mongoose.Schema({ bucket: 'string', name: 'string', version: 'string', normalizedVersion: 'string', path: 'string', fileSize: 'number', downloads: 'number', uploads: 'number', metadata: 'mixed' }, { timestamps: true });
