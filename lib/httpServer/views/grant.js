...
function generate() {
    ...
    var createArtifacts = $('#createCheckbox').val() == 'on';
    var updateArtifact = $('#updateCheckbox').val() == 'on';
    var removeArtifact = $('#removeCheckbox').val() == 'on';
    ...
    $.ajax({
        ...
        data: JSON.stringify({
            ...
            grants: {
                buckets: buckets,
                artifactsCreate: createArtifacts,
                artifactUpdate: updateArtifact,
                artifactRemove: removeArtifact
            }
        }),
