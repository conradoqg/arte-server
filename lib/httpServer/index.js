    ...
    constructor(dbService, bucketService, artifactService) {
        ...
        this.app.get('/', async (req, res) => {
            ...
            res.render('index.pug', {
                pageTitle: 'Index',
                buckets,
                message: 'Please select a bucket to view the artifacts'
            });
        });
        ...
        this.app.get('/buckets/:bucketName/artifacts', async (req, res) => {
            ...
            const artifacts = await artifactService.getArtifacts(bucket);
            ...
            if (req.accepts('html')) {
                ...
                res.render('index.pug', {
                    pageTitle: `Arte - Bucket ${bucketName}`,
        ...
        this.app.get('/buckets/:bucketName/artifacts/:artifactName/:version?', async (req, res) => {
            if (!req.accepts('json') && !req.accepts('zip') && !req.accepts('html')) throw new HTTPError(406, 'Not Acceptable');
            ...
            if (typeof (metadata.download) == 'string') {
                forceDownload = true;
            ...
            if (req.accepts('html') && !forceDownload) {
                let message = null;
