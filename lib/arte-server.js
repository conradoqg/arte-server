...
module.exports = function arteServer(host, port, logLevel, mongoURL, storagePath, env) {
    ...
    (async () => {
        try {
            ...
            // TODO: Find a good way to store this: file?, db?, options?, env?
            ...
            const artifactService = new Artifact(dbService.storage, dbService.metadata, webhookService);
            const server = new HTTPServer(dbService, bucketService, artifactService, webhookService, authService);
